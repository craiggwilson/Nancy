namespace Nancy.ViewEngines
{
    ...
    public interface IViewResolver : IHideObjectMembers
    {
        ...
        /// <param name="modelContext">The modelContext that will be used with the view.</param>
        ...
        ViewLocationResult GetViewLocation(string viewName, ModelContext modelContext, ViewLocationContext viewLocationContext);
    }
}